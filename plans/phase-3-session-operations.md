...
### U-02: `Cmd + Shift + 2...9` による複数枚セッション開始が未実装
- 仕様上は存在するが、デスクトップUI上で動いていない
...
- `Cmd + Shift + 1` を本当の `1枚セッション新規生成` にする
- `Cmd + Shift + 2...9` で指定枚数セッションを生成できるようにする
...
- `Cmd + Shift + 1` で1枚セッション新規生成
- `Cmd + Shift + 2...9` で複数枚セッション新規生成
- `color_slot` を `開いているセッションが使っていない最小番号` から割り当てる
 - 上限到達時は新規生成を行わない

Gate:
- `Cmd + Shift + 1` で1枚セッションを新規生成できる
- `Cmd + Shift + 2` で2枚セッションを新規生成できる
